const questions = [
    ...
    {
        question: "বৌদ্ধ ধর্মে ‘সংঘ’ বলতে বোঝায় কী?",
        options: ["রাজ্য", "ভিক্ষুদের সংগঠন", "ধর্মশালা", "মঠ"],
        answer: "ভিক্ষুদের সংগঠন",
        userAnswer: null,
        status: null
    },
    {
        question: "গৌতম বুদ্ধ শেষ ভাষণ কোথায় দিয়েছিলেন?",
        options: ["সারনাথ", "রাজগৃহ", "কুশীনগর", "বোধগয়া"],
        answer: "কুশীনগর",
        userAnswer: null,
        status: null
    },
    {
        question: "গৌতম বুদ্ধকে 'তথাগত' বলা হয় কেন?",
        options: ["কারণ তিনি রাজা ছিলেন", "কারণ তিনি সত্য উপলব্ধি করেছিলেন", "কারণ তিনি যুদ্ধজয়ী ছিলেন", "কারণ তিনি উপাসনা করতেন"],
        answer: "কারণ তিনি সত্য উপলব্ধি করেছিলেন",
        userAnswer: null,
        status: null
    },
    {
        question: "নিচের কোনটি বৌদ্ধ ধর্মের মৌলিক নীতি নয়?",
        options: ["অহিংসা", "মধ্যমার্গ", "যজ্ঞ", "নির্বাণ"],
        answer: "যজ্ঞ",
        userAnswer: null,
        status: null
    },
    {
        question: "বৌদ্ধ ধর্মে ‘অবিদ্যা’ বলতে কী বোঝায়?",
        options: ["জ্ঞান", "তপস্যা", "অজ্ঞতা", "দান"],
        answer: "অজ্ঞতা",
        userAnswer: null,
        status: null
    },
    ...
    {
        question: "গৌতম বুদ্ধ কোথায় বোধিজ্ঞান লাভ করেন?",
        options: ["সারনাথ", "রাজগৃহ", "বোধগয়া", "লুম্বিনী"],
        answer: "বোধগয়া",
        userAnswer: null,
        status: null
    },
    {
        question: "গৌতম বুদ্ধের মতে মানুষের দুঃখের মূল কারণ কী?",
        options: ["তপস্যা", "লোভ", "ভয়", "অজ্ঞতা"],
        answer: "লোভ",
        userAnswer: null,
        status: null
    },
    {
        question: "গৌতম বুদ্ধের শিক্ষায় 'মধ্যমার্গ' বলতে কী বোঝায়?",
        options: ["যজ্ঞের পথ", "অত্যন্ত কঠিন জীবন", "নেশার পথ", "উপযুক্ত জীবনধারা"],
        answer: "উপযুক্ত জীবনধারা",
        userAnswer: null,
        status: null
    },
    {
        question: "বুদ্ধ কোন বংশে জন্মগ্রহণ করেন?",
        options: ["মৌর্য", "শাক্য", "নন্দ", "লিচ্ছবি"],
        answer: "শাক্য",
        userAnswer: null,
        status: null
    },
    {
        question: "বুদ্ধকে ‘শাক্যসিংহ’ কেন বলা হয়?",
        options: ["কারণ তিনি যুদ্ধ করতেন", "কারণ তিনি শাক্য বংশীয় ও সাহসী ছিলেন", "কারণ তিনি রাজা ছিলেন", "কারণ তিনি সিংহাসনে বসেছিলেন"],
        answer: "কারণ তিনি শাক্য বংশীয় ও সাহসী ছিলেন",
        userAnswer: null,
        status: null
    },
    {
        question: "গৌতম বুদ্ধের মতে সঠিক দৃষ্টিভঙ্গি কী?",
        options: ["অজ্ঞতা", "মোহ", "সত্য ও পরিপূর্ণ জ্ঞান", "ভক্তি"],
        answer: "সত্য ও পরিপূর্ণ জ্ঞান",
        userAnswer: null,
        status: null
    },
    {
        question: "বৌদ্ধ ধর্ম অনুযায়ী কতটি আর্য সত্য আছে?",
        options: ["তিনটি", "চারটি", "পাঁচটি", "দু’টি"],
        answer: "চারটি",
        userAnswer: null,
        status: null
    },
    {
        question: "‘ত্রিপিটক’ বলতে কী বোঝায়?",
        options: ["তিন বর্ণ", "তিন দেবতা", "তিন গ্রন্থ", "তিন ভাষা"],
        answer: "তিন গ্রন্থ",
        userAnswer: null,
        status: null
    },
    {
        question: "গৌতম বুদ্ধের মৃত্যুর সময় তাঁর বয়স কত ছিল?",
        options: ["৬০ বছর", "৭২ বছর", "৮০ বছর", "৯০ বছর"],
        answer: "৮০ বছর",
        userAnswer: null,
        status: null
    },
    {
        question: "বৌদ্ধ ধর্মের উদ্দেশ্য কী?",
        options: ["ধন অর্জন", "রাজনীতি", "মোক্ষ লাভ", "যজ্ঞ করা"],
        answer: "মোক্ষ লাভ",
        userAnswer: null,
        status: null
    },
    {
        ...
        options: ["লুম্বিনী", "বোধগয়া", "কুশীনগর", "সারনাথ"],
        answer: "লুম্বিনী",
        userAnswer: null,
        status: null
    },
    {
        question: "বৌদ্ধদের মতে মানবজীবন কী?",
        options: ["অবিনশ্বর", "দুঃখময়", "সুখময়", "অদৃশ্য"],
        answer: "দুঃখময়",
        userAnswer: null,
        status: null
    },
    {
        question: "গৌতম বুদ্ধের শিক্ষার মূল লক্ষ্য কী ছিল?",
        options: ["পূজা অর্চনা", "দর্শন চর্চা", "মানব মুক্তি", "রাজ্য শাসন"],
        answer: "মানব মুক্তি",
        userAnswer: null,
        status: null
    },
    {
        question: "‘সম্যক বাক্’ অর্থ কী?",
        options: ["সত্য কথা বলা", "জোরে কথা বলা", "পুজো করা", "নীরব থাকা"],
        answer: "সত্য কথা বলা",
        userAnswer: null,
        status: null
    },
    {
        question: "কোন রাজা বৌদ্ধ ধর্ম মেনে কলিংগ যুদ্ধ পরিত্যাগ করেন?",
        options: ["বিম্বিসার", "অজাতশত্রু", "অশোক", "চন্দ্রগুপ্ত"],
        answer: "অশোক",
        userAnswer: null,
        status: null
    },
    {
        question: "বৌদ্ধ ধর্ম অনুসারে দুঃখ নাশের উপায় কী?",
        options: ["যজ্ঞ", "অষ্টাঙ্গিক মার্গ", "স্নান", "তপস্যা"],
        answer: "অষ্টাঙ্গিক মার্গ",
        userAnswer: null,
        status: null
    },
    {
        question: "‘সম্যক কর্ম’ অর্থ কী?",
        options: ["পূজার কাজ", "ভুল কাজ", "সৎ ও ন্যায় কাজ", "অজ্ঞান কাজ"],
        answer: "সৎ ও ন্যায় কাজ",
        userAnswer: null,
        status: null
    },
    {
        question: "‘সংঘ’ কী?",
        options: ["একটি ধর্মগ্রন্থ", "বৌদ্ধ ভিক্ষুদের গোষ্ঠী", "পুজোর স্থান", "রাজনৈতিক দল"],
        answer: "বৌদ্ধ ভিক্ষুদের গোষ্ঠী",
        userAnswer: null,
        status: null
    },
    {
        question: "গৌতম বুদ্ধ কোন নদীর তীরে ধ্যানমগ্ন হয়েছিলেন?",
        options: ["গঙ্গা", "নিরঞ্জনা", "যমুনা", "সীতানদী"],
        answer: "নিরঞ্জনা",
        userAnswer: null,
        status: null
    },
    {
        question: "‘অহিংসা’ বৌদ্ধ ধর্মে কী বোঝায়?",
        options: ["শক্তি প্রয়োগ", "দান করা", "অন্যকে আঘাত না করা", "পুজো করা"],
        answer: "অন্যকে আঘাত না করা",
        userAnswer: null,
        status: null
    }
];
